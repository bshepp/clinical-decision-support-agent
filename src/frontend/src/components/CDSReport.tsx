    ...
    <div className="space-y-6">
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <p className="text-xs text-gray-400">
          Generated by CDS Agent · MedGemma (HAI-DEF)
        </p>
      </div>
      ...
      {report.drug_interaction_warnings.length > 0 && (
        <Section title="⚠️ Drug Interaction Warnings">
      ...
      {report.guideline_recommendations.length > 0 && (
        <Section title="📖 Guideline-Concordant Recommendations">
      ...
      <Section title="➡️ Suggested Next Steps">
        <div className="space-y-2">
